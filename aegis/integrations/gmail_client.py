...
gmail.readonly scope - silme/etiket degistirme yetkisi yok). OAuth akisi
aegis.integrations.google_auth'ta ORTAK (Calendar ile paylasilir).
...
from aegis.integrations.google_auth import GoogleAuthError, load_credentials

GmailAuthError = GoogleAuthError  # geriye-donuk isim - send_email_tool.py bunu import ediyor.
