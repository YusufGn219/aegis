...
class MoveFileTool(Tool):
    name = "move_file"
    description = "Bir dosyayi baska bir klasore tasir."
            ...
            "parameters": {
                ...
                "properties": {
                    "source": {
                        "type": "string",
                        "enum": filename_enum,
                        "description": "Tasinacak dosyanin kullanicinin yazdigi adi. Yoksa YOK.",
                    },
                    "destination": {
                        "type": "string",
                        "enum": folder_enum,
    ...
    def execute(self, resolved_args: dict, ctx: ToolContext) -> ToolResult:
        ...
        return ToolResult(
            success=True,
            message=f"{source_path} -> {target_path} tasindi.",
